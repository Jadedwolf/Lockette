...
public class DoorCloser implements Runnable {
   ...
   public DoorCloser( Lockette lockette ) {
   ...
   public boolean start( ) {
      ...
      doorTask = lockette.getServer().getScheduler().scheduleSyncRepeatingTask(lockette, this, 100, 10);
      if (doorTask == -1)
         return (true);
   ...
   public boolean stop( ) {
      ...
      lockette.getServer().getScheduler().cancelTask(doorTask);
      doorTask = -1;
      cleanup();
   ...
   private void close( closeTask door ) {
      ...
      toggleHalfDoor(door.world.getBlockAt(door.x, door.y, door.z), door.effect);
   }
